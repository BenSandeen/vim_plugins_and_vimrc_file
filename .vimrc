...
" move to a different window.  As of 13 Apr. 2017, the version with the
" lowercase 'j' works, while that with the uppercase 'J' does not.
map <C-J> <C-W>j
" map <C-j> <C-W>j
map <C-K> <C-W>k
map <C-L> <C-W>l
...
" Since I installed the auto-pairs plugin, this stuff for auto-adding brackets
" and whatnot is useless, so I'm commenting it out
...
" This one is still useful, however
inoremap << <<<Space>
...
" for clippy.vim plugin (for linting rust)
